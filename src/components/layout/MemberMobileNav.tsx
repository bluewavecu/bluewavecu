    ...
    open && mounted ? (
      <div className="fixed inset-0 z-[200] lg:hidden">
        ...
        <aside
          ...
          className="absolute inset-y-0 left-0 flex h-full w-[min(100%,20.5rem)] min-h-0 flex-col bg-white shadow-2xl dark:bg-[#071526]"
        >
          <div className="flex shrink-0 items-center justify-between border-b border-primary-navy/[0.08] px-4 py-3 dark:border-white/[0.08]">
          ...
          <div className="shrink-0 space-y-2 border-t border-primary-navy/[0.08] bg-[#f7fbff] p-4 dark:border-white/[0.08] dark:bg-white/[0.04]">
            <div className="px-1">
              <LanguageSelector
