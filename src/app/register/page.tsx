        ...
        <section className="flex items-center justify-center px-4 py-10 sm:px-6">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-lg border border-primary-navy/[0.08] bg-white p-6 shadow-[0_24px_90px_rgba(10,42,94,0.12)] dark:border-white/[0.08] dark:bg-white/[0.06] sm:p-8">
              <div className="mb-7">
                <p className="text-sm font-semibold uppercase text-ocean-blue">Enroll</p>
                ...
                <p className="mt-2 text-sm leading-6 text-bluewave-gray dark:text-white/[0.62]">
                  Submit your application for online banking access. New memberships are reviewed
                  before activation.
                </p>
              </div>
              <RegisterForm />
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="max-w-xl justify-self-start">
              ...
              <h2 className="mt-7 text-5xl font-semibold leading-tight">
                Join Bluewave Credit Union.
              </h2>
              <p className="mt-5 text-lg leading-8 text-white/[0.70]">
                Provide your personal and contact details so our team can verify eligibility and
                activate your accounts.
              </p>
            </div>

            <div className="grid max-w-xl gap-4 sm:grid-cols-2">
              {["Identity verification", "Pending account review"].map((item) => (
                <div
                  key={item}
